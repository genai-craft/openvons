...
CHECKS: list[Check] = [
    ...
    Check("shoplift", "万引き", "店舗・街", "Is a person hiding merchandise in a bag, pocket or clothing without paying?", risk="medium", style=CCTV,
    ...
    Check("no_helmet", "ヘルメット未着用", "工事現場", "Is anyone on the construction site not wearing a hard hat (safety helmet)?", risk="medium", style=SITE,
    ...
    Check("intrusion", "立入禁止区域への侵入", "工事現場", "Does a person climb over or pass through a fence, gate or barrier into a restricted area?", risk="medium", style=CCTV,
          ...
          normal_prompts=["A person walks along the outside of a chain-link fence with a KEEP OUT sign and continues down the sidewalk at dusk.",
                          ...
                          "A security guard opens a gate with a key, enters the yard and closes it behind him."]),
    ...
    Check("abandoned_bag", "放置された荷物", "店舗・街", "Does a person leave a bag or suitcase behind and walk away from it?", risk="medium", style=CCTV,
